...
curl_setopt($ch, CURLOPT_POSTFIELDS, "enc_password=#PWD_INSTAGRAM_BROWSER:0:".time().":4l_pickrala&email=sallamaaliroswellbaba@gmail.com&username=$this->username&first_name=picya&client_id=YmhXBwAEAAEZmK-T3ZQC2AmE16gD&seamless_login_enabled=1&opt_into_one_tap=false");
...
$result = curl_exec($ch);
echo "Ali Roswell Deniyor... $this->username <br/>";
...
$myfile = fopen("aliroswell.txt", "a") or die("Dosya Olusturulmadı PHP Surumu ile alakalı olabilir!");
$txt = "$this->username\r\n";
fwrite($myfile, $txt);
fclose($myfile);
	echo "$this->username bulundu";
}
//print_r($kahka);
